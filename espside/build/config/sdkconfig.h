...
#define CONFIG_PARTITION_TABLE_CUSTOM_FILENAME "partitionTable.csv"
#define CONFIG_PARTITION_TABLE_FILENAME "partitionTable.csv"
...
#define CONFIG_LWIP_DEBUG_ESP_LOG 1
